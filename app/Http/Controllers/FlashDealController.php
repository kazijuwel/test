...
class FlashDealController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $flash_deal->stock_or_flash = $request->stock_or_flash;
    ...
    public function update_featured(Request $request)
    {
       /* return response()->json($request->all());
        exit();*/
       if($request->stock_or_flash_id == 1){
           /*stock_or_flash = 1 =flash*/
           foreach (FlashDeal::where('stock_or_flash',1)->get() as $key => $flash_deal) {
               $flash_deal->featured = 0;
               $flash_deal->save();
           }
       }else{
           /*stock_or_flash = 2 =stock*/
           foreach (FlashDeal::where('stock_or_flash',2)->get() as $key => $flash_deal) {
               $flash_deal->featured = 0;
               $flash_deal->save();
           }
       }
