...
class WalletController extends Controller
{
    ...
    public function index()
    {
        if(Agent::isMobile()){
            ...
            $addons=Addon::where('unique_identifier', 'offline_payment')->first();
            if(($addons != null) && ($addons->activated)){
                 $addon=true;
            }else{
                 $addon=false;
            }

            return view($this->device.'.customer.wallet', compact('wallets','addon'));
