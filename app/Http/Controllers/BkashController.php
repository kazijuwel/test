...
class BkashController extends Controller
{
    ...
    public function pay(){
        ...
        if(Session::has('advancePayment')){
            $amount =Session::get('advancePayment');
        }
        ...
        $resultdata = curl_exec($url);
        curl_close($url);
        //dump(json_decode($resultdata));
        //log file

        $myfile = fopen("bkashtoken.txt", "w") or die("Unable to open file!");
        $txt = $resultdata;
        fwrite($myfile, $txt);
        fclose($myfile);
        //end log file
    ...
    public function checkout(Request $request){
        ...
        $requestbody = array(
            ...
            'currency' => 'BDT',
            'intent' => 'sale',
            'merchantInvoiceNumber'=>'Pro'.Session::get('order_id')
        );
        ...
        curl_close($url);
        //log file
        $myfile = fopen("bkashcheckout.txt", "w") or die("Unable to open file!");
        $txt = $resultdata;
        fwrite($myfile, $txt);
        fclose($myfile);
        //end log file
    ...
    public function excecute(Request $request){
        ...
        //log file
        $myfile = fopen("excecute.txt", "w") or die("Unable to open file!");
        $txt = $resultdata;
        fwrite($myfile, $txt);
        fclose($myfile);
        //end log file
