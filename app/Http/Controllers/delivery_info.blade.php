                            ...
                            @php
                                ...
                                //al
                                                 if($product->shipping_cost){
                                                            ...
                                                            $product_shipping_cost = $product->shipping_cost*$cartItem['quantity'];
                    }
                     if($product->category->commision_rate){
                     if($product->added_by == 'admin'){
                     $product_commision_rate = 0;
                     }else{
                     $product_commision_rate= (($product->unit_price*$product->category->commision_rate)/100 )*$cartItem['quantity'];
                     $product_commision_rate_only_price = (($product->unit_price*$product->category->commision_rate)/100 );
                     }
                            ...
                            <li class="list-group-item px-0 px-lg-3">
                                <div class="row gutters-5">
                                    ...
                                    <div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0">
                                        ...
                                        <span class="fw-600 fs-16">{{ single_price($cartItem['price']+$product->shipping_cost +$product_commision_rate_only_price) }}</span>
                                    </div>
                                    ...
                                    <div class="col-lg col-4 order-3 order-lg-0 my-3 my-lg-0">
                                        ...
                                        <span class="fw-600 fs-16 text-primary">{{ single_price(($cartItem['price']+$cartItem['tax'])*$cartItem['quantity']+$product_shipping_cost +$product_commision_rate) }}</span>
                                    </div>
