...
class OrderController extends Controller
{
    ...
    public function trackOrder(Request $request)
    {
        ...
        if($request->has('order_code')){
            ...
            if($order != null){
                ...
                foreach ($order->orderDetails as $key => $orderDetail){
                    $details_order['delivery_status'] =$orderDetail->delivery_status;
                    $details_order['product_name']=   $orderDetail->product->name;
                    $details_order['quantity']=   $orderDetail->quantity;
                    $details_order['ship_by']=  $orderDetail->product->user->name;
                }              
            }
        ...
        return response()->json([
            'error' => true,
            'message' => translate('Your order Tracking Number Can not Found')
        ]);
        }
    }
