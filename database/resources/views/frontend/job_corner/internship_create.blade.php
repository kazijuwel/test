    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <form id="shop" class="" action="{{ route('jobs.internship.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="p-3">
                                ...
                                <div class="custom-file">
                                    <label class="custom-file-label">
                                        <input type="file" class="custom-file-input" name="internship_cv">
