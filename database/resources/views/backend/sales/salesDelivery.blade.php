...
@section('content')
    <div class="card">
        <div class="card-header">
          <h1 class="h2">{{ translate('Sale Order Details') }}</h1>
        </div>
    		...
    		<div class="clearfix float-right">
    			<table class="table">
        			...
        			<tr>
        				...
        				<td>
        					{{ single_price($orderDetails->sum('tax')) }}
        				</td>
        			</tr>
                    <tr>
        				<td>
        				...
        				<td>
        					{{ single_price($orderDetails->sum('delivry_methods_charge') ) }}
        				</td>
        			</tr>
                    {{--<tr>
        				<td>
        			...
        			<tr>
        				...
        				<td class="text-muted h5">
        					{{ $orderDetails->sum('price')+$orderDetails->sum('commision')+$orderDetails->sum('shipping_cost')+$orderDetails->sum('tax')-$order->coupon }}
        				</td>
        			</tr>
        			</tbody>
    			</table>
