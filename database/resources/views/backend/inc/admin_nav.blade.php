<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    <div class="d-xl-none d-flex">
        ...
        <div class="aiz-topbar-logo-wrap d-flex align-items-center justify-content-start">
            ...
            @endphp
            <a href="{{ route('admin_dashboard') }}" class="d-block"> 
                @if($logo != null)
    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            @php
                ...
                $payment_request = \App\SellerWithdrawRequest::where('viewed', 0)->count();
            @endphp
                ...
                <div class="align-items-stretch d-flex dropdown">
                    <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="btn btn-icon p-1">
                            <span class=" position-relative d-inline-block">
                                ...
                                @if($orders > 0 || $sellers > 0 || $payment_request > 0)
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg py-0">
                        ...
                        <ul class="list-group c-scrollbar-light overflow-auto" style="max-height:300px;">
                            ...
                            <li class="list-group-item">
                                <a href="{{ route('withdraw_requests_all') }}" onClick="payment_notification(2)" class="text-reset">
                                    <span class="ml-2">{{translate('New Payment Request')}}</span>
                                </a>
                            </li>
                            @endif
                        </ul>
...
<script type="text/javascript">
    function payment_notification(id)
  {
        var payment_id = id;

        $.post('{{ route('commissions.pay_to_seller') }}', {_token:'{{ @csrf_token() }}',payment_id:payment_id}, function(data){
        });
  }
</script>
