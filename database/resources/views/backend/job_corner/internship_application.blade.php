...
<div class="card">
    ...
    <div class="card-body">
        <table class="table aiz-table mb-0">
            ...
            <tbody>
                @foreach ($internship_applications as $key => $application)
                    <tr>
                        <td>
                           {{ $loop->iteration }}
                        </td>
                        ...
                        @php
                        $path_parts = pathinfo($application->internship_cv); 
                        $extention_name = pathinfo($application->internship_cv, PATHINFO_EXTENSION)
                        @endphp
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{asset($application->internship_cv)}}" download="{{ substr($path_parts['basename'],11) }}" title="{{ translate('Download CV') }}">
