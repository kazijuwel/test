        ...
        <form class="" id="sort_categories" action="" method="GET">
          <div class="col-auto">
            <div class="form-group mb-0">
              <button type="submit" value="priority" name="button" class="btn btn-primary">{{ translate('Filter by Priority') }}</button>
            </div>
          </div>
          </form>
        <form class="" id="sort_categories" action="" method="GET">
            ...
            <tbody>
                @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td class="text-right">
                            <a target="_blank" class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('categories.edit', ['id'=>$category->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
