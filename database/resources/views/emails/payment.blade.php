...
<p style="color: black;">{{$payment_received_mail}}</p>

<p style="color: black;">Your paid amount is {{ single_price($order->grand_total) }} by {{$order->payment_type}} is received successfully</p>
