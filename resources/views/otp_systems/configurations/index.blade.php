...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('24 SMS BD Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="metrotel">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="METROTEL_SMS_API_TOKEN">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('24SMSBD SMS API TOKEN')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="METROTEL_SMS_API_TOKEN" value="{{  env('METROTEL_SMS_API_TOKEN') }}" placeholder="24SMSBD SMS API TOKEN" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="METROTEL_SMS_SID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('24SMSBD SMS SID')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="METROTEL_SMS_SID" value="{{  env('METROTEL_SMS_SID') }}" placeholder="24SMSBD SMS SID" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="METROTEL_SMS_URL">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('24SMSBD SMS URL')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="METROTEL_SMS_URL" value="{{  env('METROTEL_SMS_URL') }}" placeholder="24SMSBD SMS URL" >
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Robi SMS Panel Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="robi_sms_credential">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="robi_sms_username">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('Username')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="robi_sms_username" value="{{  env('robi_sms_username') }}" placeholder="Username" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="robi_sms_password">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('Password')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="robi_sms_password" value="{{  env('robi_sms_password') }}" placeholder="Password" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="robi_sms_from">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('SMS From')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="robi_sms_from" value="{{  env('robi_sms_from') }}" placeholder="SMS From">
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
