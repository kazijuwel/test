                      ...
                      <div class="card-body p-0">
                        <ul class="nav nav-pills flex-column">
                          @isset($conversations)
                            ...
                            {{-- @if () --}}
                            <li class="nav-item">
                              <a href="{{ route('admin.message', $to) }}" class="nav-link @if(isset($messageTo) && $messageTo->id == $to->id) active @endif ">
                  ...
                  <div class="col-lg-6 col-md-8">
                    ...
                    <div class="card p-2">
                      <div class="card-header border">
                        ...
                        <a class="btn m-0 py-0 border w3-hover-shadow float-right" href="{{ route('admin.message', $messageTo) }}">
                      ...
                      <div class="card-body">
                        <div class="">
                          <form action="{{ route('send.message', $messageTo) }}" method="post">
                            @csrf
                            <input type="hidden" name="role_from" value="admin">
