        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body text-center">
                    <form class="form-inline-" action="{{route('admin.postUpdateDestination',$dest)}}" method="post"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group- text-left">
                            <div class="form-group pb-3 {{ $errors->has('image') ? 'has-error' : '' }}">
                                <label for="image">Image (1285 X 446):</label>
                            ...
                            <div class="form-group pb-3 {{ $errors->has('image') ? 'has-error' : '' }}">
                                ...
                                <textarea name="description" class="form-control" id="description"
                                    style="height: 40px;" rows="8" >{!!old('description') ? : $dest->description!!}</textarea>
