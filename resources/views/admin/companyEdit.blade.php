            ...
            <div class="col-sm-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fa fa-edit"></i> Update Company Details of <span
                                class="badge badge-default">{{ $company->title }}</span>
                        </h3>
                    </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-12">
                                <div class="card card-widget">
                                    <div class="card-header with-border">
                                        <h3 class="card-title"><i class="fa fa-user"></i> User (Company Owner)
                                            Information</h3>
                                    </div>
                                    <div class="card-body w3-light-gray pb-0 ">
                                        <div class="row">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select id="user"
                                                                ...
                                                                @if($company->user)
                                                                    <option
                                                                        value="{{ $company->user_id }}">{{ $company->user->mobileOrEmail() }}</option>
                                                                @endif
                                                            </select>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card card-widget">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fa fa-briefcase text-primary"></i> <span
                                                        class="badge badge-light"> Balance Update </span> </h3>
                                            </div>
                                            <div class="card-body" style="min-height: 200px;">
                                                <form method="post" enctype="multipart/form-data"
                                                      action="{{ route('admin.companyBalanceUpdate', $company) }}">
                                                    @csrf

                                                    <div class="form-group">
                                                        <label for="balance">Update Balance ({{$company->balance}})</label>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card card-widget">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fa fa-briefcase text-primary"></i> <span
                                                        class="badge badge-light"> Company Information  </span> </h3>
                                            </div>
                                            <div class="card-body" style="min-height: 200px;">

                                                <form method="post" enctype="multipart/form-data"
                                                      action="{{ route('admin.companyUpdate', $company) }}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" class="form-control"
                                                               ...
                                                               value="{{ old('title') ?: $company->title }}" id="title">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="commission" class="form-control" min="2"
                                                               max="100"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="mobile" class="form-control"
                                                               ...
                                                               value="{{ old('mobile') ?: $company->mobile }}" id="mobile">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ old('nid') ?: $company->nid }}" name="nid"
                                                               class="form-control" placeholder="National ID" id="nid"
                                                               type="text">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="trade_lic">Trade Licence</label>
                                                        <input name="trade_lic" class="form-control" placeholder="Trade Licence"
                                                               id="trade_lic" type="text"
                                                               value="{{old('trade_lic') ?: $company->trade_lic }}">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="city" class="form-control"
                                                               ...
                                                               value="{{ old('city') ?: $company->city }}" id="city">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="country" class="form-control"
                                                               ...
                                                               value="{{ old('country') ?: $company->country }}" id="country">
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-8">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" name="logo" class="form-control"
                                                                       ...
                                                                       value="{{ old('logo') ?: $company->logo_name }}"
                                                                       id="logo">
                                                            </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <div class="widget-user-image">
                                                                <img width="150" class="img-circle elevation-2"
                                                    ...
                                                    <div class="form-group form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" name="status"
                                                                   type="checkbox" {{ $company->status == 'active' ? 'checked' : ''}} >
                                                            Active
                                                        </label>
                                                    </div>
                                                    <div class="form-group form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" name="approved"
                                                                   type="checkbox" {{ $company->approved == 1 ? 'checked' : ''}} >
                                                            Approved
                                                        </label>
                                                    </div>
