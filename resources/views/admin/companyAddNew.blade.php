                                                            ...
                                                            <select id="user" name="user"
                                                                ...
                                                                @if ($company->user)
                                                                    <option value="{{ $company->user_id }}">
                                                                        {{ $company->user->mobileOrEmail() }}</option>
                                                                @endif
                                                            </select>
                                    ...
                                    <div class="card-body" style="min-height: 200px;">
                                        ...
                                        <form method="post" action="{{ route('admin.companyUpdate', $company) }}">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="number" name="commission" class="form-control" min="2" max="100"
    ...
    <input type="text" name="login_type" class="form-control" placeholder="Enter login type" value="{{ old('login_type') ?: $company->login_type }}" id="login_type">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" class="form-control"
                                                    placeholder="Company Address" id="address" cols="30"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="zip_code" class="form-control"
                                                    ...
                                                    value="{{ old('zip_code') ?: $company->zip_code }}" id="zip_code">
                                            </div>
                                            ...
                                            <div class="form-group form-check">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" name="status" type="checkbox"
                                                        {{ $company->status == 'active' ? 'checked' : '' }}> Active
                                                </label>
                                            </div>
