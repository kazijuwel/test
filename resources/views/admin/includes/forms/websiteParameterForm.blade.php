...
<div class="card card-widget">
  <div class="card-body">
    ...
    <div class="form-group {{ $errors->has('youtube_url') ? ' has-error' : '' }}">
      ...
      <input type="text" name="youtube_url" class="form-control" value="{{old('youtube_url') ?: $post->youtube_url ?? ''}}" id="youtube_url" placeholder="https://youtube.com/page.username" autocomplete="off">
    ...
    <div class="form-group {{ $errors->has('instagram_url') ? ' has-error' : '' }}">
      ...
      <input type="text" name="instagram_url" class="form-control" value="{{old('instagram_url') ?: $post->instagram_url ?? ''}}" id="instagram_url" placeholder="https://instagram.com/page.username" autocomplete="off">
