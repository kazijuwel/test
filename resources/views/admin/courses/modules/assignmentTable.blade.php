        ...
        <div class="container">
            <div class="card">
                @if (isset($assignmentFields))
                        <form class="" action="{{ route('admin.updateCourseAssignment', [$course, $assignmentFields]) }}" method="POST" enctype="multipart/form-data">
                @else
                        <form class="" action="{{ route('admin.saveCourseAssignment', [$course]) }}" method="POST" enctype="multipart/form-data">
                @endif
                    @csrf
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                    <a title="edit" class="w3-btn p-1 px-2 w3-small w3-border"
                                        href="{{ route('admin.editCourseAssignment', [ $course, $assignment]) }}">
