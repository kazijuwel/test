...
--}}
		...
		<option value="{{ $subject->id }}">{{ $subject->title }}</option>
            ...
            <div class="form-group form-group-sm {{ $errors->has('course_credit') ? ' has-error' : '' }}">
                <label for="course_credit">Course Credit/fees:</label>
            ...
            <div class="form-group form-group-sm {{ $errors->has('course_mode') ? ' has-error' : '' }}">
                ...
                <select name="course_mode" id="course_mode" class="form-control" required>
                    ...
                    @endif
                    <option value="course" @if(isset($course->course_mode) && $course->course_mode == 'course') selected @endif >eLearning Course</option>
...
<div class="card" id="descPointDiv" style="display: none">
    <div class="card-header h5">
            Description Points
        <button class="btn btn-primary float-right" onclick="event.preventDefault(); addField()"> <i class="fa fa-plus"></i>add new field</button>
    </div>
    <div class="card-body" id="descPoint">
        @if (isset($course) && $course->descriptionPoints->count() > 0)
            @foreach ($course->descriptionPoints as $point)
            <div @if($loop->iteration > 1) class="border-top pt-2" @endif>
                <div class="form-group">
                    <label for="">Description Point Title </label>
                    <input type="text" class="form-control" name="description_point_title[]" value="{{ $point->title }}">
                </div>
                <div class="form-group">
                    <label for="">Description Point Details </label>
                    <textarea type="text" class="form-control" name="description_point_details[]">{!! $point->description !!}</textarea>
                </div>
            </div>
            @endforeach
        @endif
        <div>
            <div class="form-group">
                <label for="">Description Point Title </label>
                <input type="text" class="form-control" placeholder="title" name="description_point_title[]">
            </div>
            <div class="form-group">
                <label for="">Description Point Details </label>
                <textarea type="text" class="form-control" placeholder="description" name="description_point_details[]"></textarea>
            </div>
        </div>
    </div>
</div>
            ...
            {{-- div.form-group --}}
            <div class="h5 py-2">Features:</div>
            <div class="form-group ">
                <input type="checkbox" name="educational_research" @if($course->educational_research) checked @endif>
                <label for="accreditation">Educational research</label>
            </div>
            <div class="form-group ">
                <input type="checkbox" name="interactive" @if($course->interactive) checked @endif>
                <label for="accreditation">Interactive</label>
            </div>
            <div class="form-group ">
                <input type="checkbox" name="flexible_learning" @if($course->flexible_learning) checked @endif>
                <label for="accreditation">Flexible e-learning programme </label>
            </div>
            <div class="form-group ">
                <input type="checkbox" name="developing_leaders" @if($course->developing_leaders) checked @endif>
                <label for="accreditation">Developing leaders </label>
            </div>
            <div class="form-group ">
                <input type="checkbox" name="expert_supervision" @if($course->expert_supervision) checked @endif>
                <label for="accreditation">Expert supervisions</label>
            </div>
            {{-- div.form-group --}}
...
@push('js')
    <script>
        $(document).ready(function () {
           var mode = $("#course_mode").val()
           if (mode == 'course') {
               $("#descPointDiv").css('display', 'block');
           }
        });
        ...
        function addField() {
           ...
           <div class="mt-3 border-top">
            <div class="form-group">
                <label for="">Description Point Title </label>
                <input type="text" class="form-control" name="description_point_title[]">
            </div>
            <div class="form-group">
                <label for="">Description Point Details </label>
                <textarea type="text" class="form-control" name="description_point_details[]"></textarea>
            </div>
            </div>
            `)
        }
