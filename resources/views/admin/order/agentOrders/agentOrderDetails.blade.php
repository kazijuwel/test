...
@push('css')
    ...
    <link rel="stylesheet" href="{{ asset('assets/lightbox2/css/lightbox.css') }}">
...
@section('content')
    <section class="content">
        ...
        <div class="card card-widget">
            ...
            <div class="card-body" style="white-space: nowrap;">
                <div class="d-flex justify-content-between">
                    <div class="departsFlight">
                        ...
                        <p><b>Price</b>: {{ json_decode($order->prices)[0]->TotalPrice}}</p>
                    ...
                    @if ($order->return_flight)
                        <div class="ReturnFlight">
                            ...
                            <p><b>Price</b>: {{ json_decode($order->prices)[1]->TotalPrice}}</p>
            ...
            <div class="card-footer">
                <form action="{{route('admin.agentOrderStatusUpdate',['agent'=>$order->user_id,'order'=>$order->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="totalPrice" value="{{price_calculate_with_passenger($order->id)}}">
                    ...
                    @if ($order->status == 'confirmed')
                        ...
                        @if ($order->return_flight)
                            <div class="form-group">
                                <label for="status">Upload Return Ticket</label>
                                <input type="file" name="return_ticket">
                            </div>
                        @endif
                    @endif
