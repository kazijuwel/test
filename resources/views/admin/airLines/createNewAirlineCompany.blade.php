            ...
            <div class="col-sm-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fa fa-edit"></i> Airline Company
                        </h3>
                    </div>
                                ...
                                <div class="card card-widget">
                                    ...
                                    <div class="card card-widget">
                                        ...
                                        <div class="card-body" style="min-height: 200px;">
                                            ...
                                            <form method="post" action="{{route('admin.addNewairlineCompanyPost')}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                        placeholder="Enter Title" value="{{ old('title') }}" id="title">
                                                </div>

                                                <div class="form-group">
                                                    <label for="callsign">Company CallSign</label>
                                                    <input type="text" name="callsign" class="form-control"
                                                        placeholder="Company CallSign" value="{{ old('callsign') }}"
                                                        id="callsign">
                                                </div>
                                                <div class="form-group">
