...
@section('content')
  <section class="content">
    ...
    <form action="{{route('admin.searchData', $type)}}">
                ...
                <div class="form-group clearfix">
                    {{-- <div class="span badge">
                        <div class="icheck-primary d-inline">
                            <input type="checkbox" {{in_array('Company',$filter) ? 'checked' : ''}} value="Company" name="filter[]"  class="checkboxPrimary3">
                            <label>
                            Company
                            </label>
                        </div>
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3 mt-4">
                            ...
                            {{-- <a href="" onclick="return printDiv('printArea');" class="btn btn-md btn-primary" style="margin-left: 2rem;">Print</a> --}}
                            </div>
                        </div>
                    </div>
    ...
    <!-- /.form -->
                            ...
                            <table class="table table-hover table-sm table-bordered table-striped">
                                ...
                                <thead class="sticky1">
                                    <tr >
                                        ...
                                        <th colspan="" rowspan="" headers="" scope="">MacId/SiteId</th>                               
                                    ...
                                    <?php $i = (($items->currentPage() - 1) * $items->perPage() + 1); ?>
                                        ...
                                        @foreach ($items as $item)
                                            ...
                                            <tr class="nowrap">
                                                ...
                                                <td>{{$i}}</td>
                                                <td>
                                                    <a target="_blank" class="btn btn-xs btn-primary w3-tiny  py-0" href="{{route('admin.singleDeviceSingleDataDetails',['data'=>$item])}}">Details</a>
                                                </td>
        ...
        {{$items->appends([ 'pages'=>$pages, 'macids' => $macids, 'filter'=>$filter, 'from'=>$from,'to'=>$to, 'comps'=>$comps])->render()}}
