      ...
      <div class="col-sm-12">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">
              All @if(isset($type)) {{$type}} @endif Devices Data of {{ $company->title }}
            </h3>
              ...
              @foreach ($settingDatas as $sd)
                <tr class="nowrap">
                  ...
                  @if($sd->product->type == 'battery')
                    <a target="_blank" class="btn btn-xs btn-primary w3-tiny  py-0" href="{{route('admin.singleDeviceSingleDataDetails',['data'=>$sd])}}">Battery Details</a>
                  @elseif($sd->product->type == 'rectifier')
                    <a target="_blank" class="btn btn-xs btn-primary w3-tiny  py-0" href="{{route('admin.singleDeviceSingleDataDetails',['data'=>$sd])}}">Rectifier Details</a>
                  </td>
