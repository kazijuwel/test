        ...
        <div class="col-sm-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">
                        All Courses
                        Package:(id:{{$takenPackage->id}}),{{$takenPackage->title}}
                    </h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="card" style="min-height: 250px !important">
                                ...
                                <div class="p-2">
                                    ...
                                    <p class="text-center">
                                        <a href="{{route('user.takePackageCourse',[$takenPackage,$course])}}"
                                            class="btn btn-primary btn-sm">Take Course</a>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    @php
                    $takenCourses = $takenPackage->takenCourses()->paginate(50);
                    @endphp
                        ...
                        <table class="table table-hover w3-centered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$utc->attempt_duration}} days</td>
                                    <td>
                                        @php
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-xs">
                                            <a href="{{route('user.takenPackageCourseDetails',[$takenPackage,$utc])}}"
