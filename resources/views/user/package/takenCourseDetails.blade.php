                        ...
                        <div class="col-sm-5">
                            <div class="card card-widget">
                                ...
                                <div class="card-body p-3" style="background: #e3e3e0;">
                                    ...
                                    <a href="{{route('user.takeAttemptCourseExam',$takenCourse)}}"
                    ...
                    <div class="row mt-2">
                        <div class="table-responsive">
                            <table class="table table-sm table-striped table-hover">
                                ...
                                <tbody>
                                    @php
                                        $assignments = $takenCourse->course->individualCourseAssignments()->get();
                                    @endphp
                                    ...
                                    <td>
                                        @if (auth()->user()->assignmentAnswer($assignment->id))
                                        @php
                                            $answer = auth()->user()->assignmentAnswer($assignment->id);
                                        @endphp
                                            <div class="">
                                        ...
                                        @else
                                            <a href="{{ route('user.submitAssignment', [ $takenCourse, $assignment]) }}" class="btn btn-primary btn-sm text-white">Submit</a>
                                        @endif
