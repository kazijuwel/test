...
<head>
    ...
    <link rel="stylesheet" href="{{
                asset('user/vendor/owl.carousel/assets/owl.carousel.min.css')
            }}" />
    <link rel="stylesheet" href="{{
                asset(
    ...
    <link rel="stylesheet" href="{{
                asset('user/vendor/magnific-popup/magnific-popup.min.css')
            }}" />
    ...
    <!-- Head Libs -->
    <script src="{{
                asset('user/vendor/modernizr/modernizr.min.js')
            }}"></script>
    ...
    <link rel="stylesheet" href="{{
                asset('user/vendor/circle-flip-slideshow/css/component.css')
            }}" />
...
<body class="alternative-font-4 loading-overlay-showing" data-plugin-page-transition data-loading-overlay
    ...
    <div class="body m-0">
        @include('user.porto.part.userHeader2') @yield('content')
        ...
        @include('user.porto.part.userModal')
        @include('user.porto.part.userFooter')
    </div>
