                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="flight-booking-card">
                            <div>
                                <div class="topline d-flex flex-column align-items-center"><button class="tarek-btn-mini btn-tarek" >Depart</button></div>
                            ...
                            <div>
                                <div class="topline text-dark font-weight-bold" style="font-size: 12px">Wed, Sep 22 | Hong Kong - Kuala Lumpur</div>
                                <div class="second-grid-tarek">
                                    ...
                                    <div class="d-flex flex-column justify-content-between">
                                        <div class="text-dark" style="font-size: 11px">HKG Hong Kong International Airport T1</div>
                                        <div class="text-dark" style="font-size: 11px">KUL Kuala Lumpur International Airport M</div>
                                    </div>
                                </div>

                            </div>
                            <div >
                                <div class="w3-text-black d-flex justify-content-end topline"> <i class="icon-note icons"></i> <u> Change flight
                                </u></div>
                                <div class="third-grid-tarek">
                                    <div> <img src="{{ asset('user/svg/flight-ticket.svg') }}" height="18" alt=""></div>
                                    <div class="text-dark text-justify" style="font-size: 11px; line-height: 1.7;"> Biman Bangladesh Airlines - AX786
                                        Airbus A350 XWBEconomyIn-flight <br>
                                        <span
                                        style="border-bottom: 1px dashed;">In-flight services</span></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row pt-4">
                        <div class="flight-booking-card">
                            <div>
                                <div class="topline d-flex flex-column align-items-center"><button class="tarek-btn-mini btn-tarek" >Return</button></div>
                                <div class="d-flex flex-column align-items-center">
                                    <div class="text-dark" style="font-size: 11px">12.45</div>
                                    <div style="font-size: 11px">3h 55min</div>
                                    <div class="text-dark" style="font-size: 11px">16.40</div>
                                ...
                                <div class="card-body  w3-round-xxlarge" style="background-color: #ffff;">
                                    ...
                                    <div class="row">
                                        <div class="text-left">
                                            ...
                                            <p class="w3-text-black font-weight-bold" style="font-size: 14px">Passenger 1: Adult Ticket </p>
                                        </div>
                                    </div>
                            ...
                            <div class="card bg-color-grey w3-round-xxlarge">
                                <div class="card-body  w3-round-xxlarge"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="text-left">
                                                <p class="w3-text-black font-weight-bold" style="font-size: 14px">Contact Details</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="text-left">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" name="checkboxes[]" type="checkbox"
                                                        ...
                                                        id="inlineCheckbox1" value="option1"> <span style="font-size:12px">Contact for Promotions</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card bg-color-grey w3-round-xxlarge">
                                <div class="card-body  w3-round-xxlarge"
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <p style="font-size: 12px; font-weight:400;word-spacing: 5px;">I have read and agreed to the following Tripbeyond.com booking terms and
