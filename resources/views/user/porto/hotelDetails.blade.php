...
@section('content')
    ...
    <div role="main" id="newBG" class="main"
        ...
        <div class="container4 pt-3 py-3">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <a class="img-thumbnail img-thumbnail-no-borders d-block img-thumbnail-hover-icon lightbox" href="{{ asset('storage/hotel/'.$hotel->image) }}" data-plugin-options="{'type':'image'}">
            ...
            <div class="container4 pt-3 py-3">
                <h3 class="text-center p-3 m-auto" style="font-weight: 700;">Related Hotels</h3>
                <div class="row">
