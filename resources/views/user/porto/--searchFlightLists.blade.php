                        ...
                        <div class="card-bacground3 border-curve2  "
                            ...
                            <form action="{{ route('welcome.flightLists') }}" method="GET">
                                ...
                                <div class="row pt-3">
                                        ...
                                        <div class="navbartexts ml-2">
                                            ...
                                            <p>
                                                <select id="user" name="from"
                                                    ...
                                                    data-ajax-delay="200" style="border: none !important; width:180px">
                                        ...
                                        <div class="navbartexts  ml-1">
                                            ...
                                            <p>
                                                <select id="modal-container" name="to"
                                                    class="seleect5 search form-control" data-placeholder="Select City"
                                                    data-ajax-url="{{ route('welcome.tripSearchAjax2') }}"
                                                    data-ajax-cache="true" data-ajax-dataType="json"
                                                    data-ajax-delay="200" style="border: none !important; width:180px">
                                                    @if ($to)
                                    ...
                                    <div class="col-md-2">
                                        <div class="navbartexts ml-2">
                                            <span style="font-size: 11px;color:orange; font-weight:600;">Depart*</span>
                                            <p>
                                                ...
                                                <input type="date" name="departs" value="{{ $departs }}"
                                                    class="flight_input" placeholder="Select Date" autocomplete="off">
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="navbartexts">
                                            <span style="font-size: 11px;color:orange; font-weight:600;">Return</span>
                                            <p>
                                            ...
                                            <div class="row pt-3" style="margin-top: -10px;">
                                                <div class="col-6 text-left" style="margin-left: -15px;">
                                                    ...
                                                    <p class="tarek-height" style="font-size: 8px; "><span
                                                            ...
                                                            style="white-space: nowrap;">06AM-8AM</span></p>

                                                    <!-- <i class="fas fa-sun text-warning" ></i> -->
                                                </div>

                                                <div class="col-6 text-right">
                                                    <p style="font-size: 9px;"><i class="fas fa-sun text-warning"></i>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="owl-carousel owl-theme stage-margin"
                                                ...
                                                <div>
                                                    ...
                                                    <div class="tarek-trip-date-card">
                                                        ...
                                                        <p class="w3-small w3-text-black" style="margin-left: -30px;">
                                                            $265
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="owl-carousel owl-theme stage-margin"
                                                ...
                                                <div>
                                                    <a href="#" style="text-decoration: none">
                                                        <div class="tarek-trip-date-card">
                                                            <p class="w3-text-black"
                                                                style="font-size: 10px; margin-left: -30px; margin-top: -20px;">
                                                                {{ Carbon\Carbon::parse($item->start)->format('D') }},
                                                                <br> <span style="white-space: nowrap;"> {{
                                                                    Carbon\Carbon::parse($item->start)->format('M y') }}
                                                                </span>
                                                            </p>
                                                            <p class="w3-small w3-text-black"
                                                                style="margin-left: -30px;">${{ $item->price }}
                                                            </p>
                                                        </div>
                                                    </a>
                                                </div>
                                                ...
                                                <div>
                                                    <div class="tarek-trip-date-card">
                                                        ...
                                                        <p class="w3-small w3-text-black" style="margin-left: -30px;">No
                                                            Schdule found for next 7 Days
                                                        </p>
                                                    </div>
                                                </div>
                                                @endforelse
                        ...
                        <div class="row">
                            <div class="col-md-10 pt-3">
                                <p style="font-size: small;">Prices displayed include taxes and may change based on
                                    availability.
                                    You can review any additional fees before check out. Prices are not final until you
                                    complete
                                    your purchase.
                                </p>
                            </div>
                                        ...
                                        <div class="flight-ticket-search">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="text-dark cardp py-1"
                                                            style="font-size: 9px; font-weight:700;">Biman Bangladesh
                                                            Airlines
                                                        </div>
                                                        <div class="text-dark cardp py-1"
                                                            style="font-size: 9px; font-weight:700;">Flight No. 786
                                                        </div>
                                            ...
                                            <div class="  pt-2">
                                                <div class="row d-flex flex-column justify-content-around">
                                                    ...
                                                    <div class="cardp" style="font-size: 11px;"> <span
                                                            class="sub-head font-weight-bold text-dark">Dhaka
                                                            (DAC)</span> </div>
                                            ...
                                            <div class=" pt-2">
                                                <div class="row d-flex flex-column justify-content-around">
                                                    ...
                                                    <div class="cardp" style="font-size: 11px;"> <span
                                                            class="sub-head text-dark font-weight-bold"> Delhi (DAC)
                                            ...
                                            <div class=" pt-2">
                                                <div class="row">
                                                    ...
                                                    <div class="cardp text-dark" style="font-size: 10px;"> 10hrs 55mins

                                                    </div>
                                                    <div class="cardp" style="font-size: 11px;"> <span
                                                            class="sub-head text-dark font-weight-bold">One Stop
                                                        </span>
                                                    </div>
                                                    <div class="text-dark cardp py-1"
                                                        style="font-size: 10px; font-weight:600;">

                                                        Seats Left : <span class="text-warning"> 9 </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="text-center">
                                                ...
                                                <div class="btn btn-tarek font-weight-bold btn-rounded" href=""> Book
                                                    Now</div>
                                                <div style="font-size: 11px;">Refundable</div>
                                        ...
                                        <div class="flight-ticket-search">
                                            ...
                                            <!-- <div class=" pt-2">
                                                <div class="row">
                                                    ...
                                                    <div class="cardp text-dark" style="font-size: 10px;">
                                                        <span class="col-12"> 10 Houre
                                                        </span> <br>

                                                    </div>

                                                    <div class="cardp" style="font-size: 11px;">
                                                        <span class="sub-head text-dark font-weight-bold">One Stop
                                                        </span>
                                                    </div>
                                                    <div class="text-dark cardp py-1"
                                                        style="font-size: 10px; font-weight:600;">
                                            ...
                                            <div class="text-center">
                                                <div class="font-weight-bold">$166 </div>
                                                <div class="btn btn-tarek font-weight-bold btn-rounded"
                                                    href="{{ route('welcome.flightBooking', ['schedule' => 1]) }}">
                                                    Book
                                                    Now</div>
                                                <div style="font-size: 11px;">Refundable</div>
