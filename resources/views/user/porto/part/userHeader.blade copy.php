                            ...
                            <div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-text-capitalize header-nav-main-text-size-2 header-nav-main-mobile-dark header-nav-main-effect-1 header-nav-main-sub-effect-1 appear-animation"
                                ...
                                <nav class="collapse">
                                    <ul class="nav nav-pills pb-3 pt-3" id="mainNav">
                                        <a class="btn btn-rounded font-weight-semibold appear-animation"
                                            style="border: 2px solid white; color:white; height:35px"
                                            data-appear-animation="fadeIn" data-plugin-options="{'accY': 100}"
                                            href="#"><small>USD <i class="icon-arrow-down icons pl-2"></i></small></a>

                                        <a class="btn  appear-animation" style="color:white; font-size:11px"
                                            data-appear-animation="fadeIn" data-plugin-options="{'accY': 100}"
                                        ...
                                        @endguest
                                        @auth
                                        {{-- <a class="btn font-weight-semibold px-2 ml-3 appear-animation text-light"
                                        ...
                                        <a class=" nav-link dropdown btn font-weight-bold px-2 ml-3 appear-animation text-light"
                                            data-appear-animation="fadeIn " data-toggle="dropdown"
                                        ...
                                        <a class="btn font-weight-semibold px-2 ml-1 appear-animation text-light"
                                            data-appear-animation="fadeIn" data-plugin-options="{ 'accY': 100} "
                                        ...
                                        <a class="btn btn-rounded font-weight-semibold ml-3 appear-animation text-dark"
                                            style="background-color: #F6931D; height: 35px;"
                                            data-appear-animation="fadeIn" data-plugin-options="{'accY': 100}" href=""
                                            data-toggle="modal" data-target="#signInAgentModal">Agent Login</a>

                                        <a class="ml-2 mt-1 text-dark d-flex justify-content-center align-items-center"
                                            style="height:28px; width:28px; border-radius:50%; background-color:#F6931D; "
                                            data-appear-animation="fadeIn" data-plugin-options="{'accY': 100}"
