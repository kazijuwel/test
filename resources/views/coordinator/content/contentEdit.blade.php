...
<!-- Info cardes -->
      ...
      @include('alerts')
        ...
        <div class="card card-widget">
            ...
            <div class="card-body">
                <div class="card card-widget">
    <form  method="post" action="{{route('coordinator.contentSave', $content)}}" enctype="multipart/form-data">
    ...
    <div class="card card-widget">
        <div class="card-body">
            ...
            <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <input type="text" name="title" class="form-control" value="{{ old('title') ?? $content->title }}" id="title" placeholder="Title of Post" autocomplete="off">
                    @if ($errors->has('title'))
            ...
            <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                <label for="description" class="control-label"> Description</label>
                    ...
                    <textarea  name="description" class="form-control" rows="10" id="description" placeholder="Description">{{ old('description') ?? $content->description }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="excerpt" class="form-control" id="excerpt" cols="30" rows="3">{{ old('excerpt') ?? $content->excerpt }}</textarea>
                    ...
                    <div class="input-group">
                        <select class="form-control" name="course" id="course">
                            @foreach($courses as $course)
                                <option value="{{$course->id}}" @if( $content->course_id == $course->id) selected @endif>{{$course->title }} ({{$course->course_type}})</option>
                                {{-- <div class="checkbox">
                                    <label>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="input-group">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" id="post" name="public" value="1" @if ($content->public)
                                checked   
                                @endif> Public
                            </label>
                        ...
                        <div class="input-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" id="post" name="public" value="0"  @if (!$content->public)
                                    checked   
                                    @endif> Private
                                </label>
