      ...
      <div class="card card-widget">
            ...
            <div class="card-body">
              ...
              <div class="card card-widget mb-0">
                ...
                @include('coordinator.subjects.includes.forms.addNewSubjectInlineForm')
    ...
    <tr>
      ...
      <td>
        <div class="btn-group ">
                  ...
                  <div class="btn-group">
                    <a href="{{route('coordinator.editSubject',$subject)}}">
                    ...
                    <a class="btn btn-danger w3-text-white btn-xs w3-hover-red" onclick="return confirm('Do you really want to delete this subject?');" href="{{ route('coordinator.subjectDelete',$subject) }}">delete</a>
