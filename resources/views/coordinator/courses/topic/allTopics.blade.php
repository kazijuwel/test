                        ...
                        <div class="card-body w3-gray p-2">
                            <div class="card card-widget mb-0">
                                <div class="card-body">
                                    ...
                                    <form action="{{route('coordinator.addNewTopicPost',$course)}}"
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a title="Delete" class="w3-btn p-1 px-2 w3-small w3-border"
                                    ...
                                    href="{{route('coordinator.deleteTopicCourseQuestionAnswer', ['type'=>'topic', 'id'=>$topic->id])}}"><i
                                    ...
                                    <div class="card card-widget mb-0 ">
                                        <div class="card-header">
                                            <form class="form-add-item"
                                                action="{{route('coordinator.addNewTopicQuestion', $topic)}}" method="post">
                                        ...
                                        <div class="all-data-area question-area card-body w3-gray p-1 ">
                                            ...
                                            @include('coordinator.courses.questions.ajax.courseQuestionsAll')
                    ...
                    <div class="card-body w3-gray p-2">
                        <div class="card card-info mb-0 bg-blue">
                            <div class="card-body">
                                ...
                                <form action="{{route('coordinator.addNewQuestionPapers',$course)}}" method="post">
                    ...
                    <div class="card card-widget form-outer-area  collapsed-card mb-3">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a title="Delete" class="w3-btn p-1 px-2 w3-small w3-border"
                                    onclick="return confirm('Do you really want to delete this Topic?');"
                                    href="{{ route('coordinator.deleteQuestionPaper', [$paper->id])}}"><i
                                        class="fa fa-times w3-text-red"></i></a>
                                ...
                                <div class="card-body w3-light-gray p-1">
                                    ...
                                    <div class="card card-widget mb-0 ">
                                        ...
                                        <div class="all-data-area question-area card-body w3-gray p-1 ">
                                            ...
                                            @include('coordinator.courses.questions.ajax.questionPaperItems')
