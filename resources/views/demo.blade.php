...
<body>
    ...
    <div class="body">
                                                        ...
                                                        <li class="dropdown-submenu">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item"
                                                                        ...
                                                                        Version 10</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-11.html" ->Corporate -
                                                                        Version 11</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-12.html" ->Corporate -
                                                                        Version 12</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-13.html" ->Corporate -
                                                                        Version 13</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-14.html" ->Corporate -
                                                                        Version 14</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-15.html" ->Corporate -
                                                                        Version 15</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-16.html" ->Corporate -
                                                                        Version 16</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-17.html" ->Corporate -
                                                                        Version 17</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-18.html" ->Corporate -
                                                                        Version 18</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-19.html" ->Corporate -
                                                                        Version 19</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-corporate-20.html" ->Corporate -
                                                                        Version 20</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu">
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item"
                                                                        href="index-classic.html">Revolution Slider</a>
                                                                </li>
                                                                <li><a class="dropdown-item"
                                                                        href="index-slider-nivo.html">Nivo Slider</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu">
        ...
        <div role="main" class="main">
            <div class="slider-container rev_slider_wrapper bg-color-grey-scale-1" style="height: 70vh;">
                <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider
                    ...
                    <ul>
                        <li data-transition="fade">
                            ...
                            <div class="tp-caption" data-x="center" data-hoffset="['-130','-130','-130','-205']"
                                data-y="center" data-voffset="['-100','-100','-100','-125']" data-start="1000"
                                data-transform_in="x:[-300%];opacity:0;s:500;" data-transform_idle="opacity:0.8;s:500;">
                                <img src="img/slides/slide-title-border-light.png" alt="">
                            </div>

                            <!-- <div class="tp-caption text-color-light font-weight-semibold" data-x="center"
                                data-y="center" data-voffset="['-100','-100','-100','-125']" data-start="700"
                            ...
                            <!-- <h1 class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
                                ...
                                data-x="center" data-y="center" data-voffset="['-50','-50','-50','-40']"
                                data-fontsize="['50','50','50','90']" data-lineheight="['55','55','55','95']">INCREDIBLE
                                DESIGNS</h1> -->

                            <div class="tp-caption font-weight-light text-color-light"
                                data-frames='[{"from":"opacity:0;","speed":300,"to":"o:1;","delay":2000,"split":"chars","splitdelay":0.05,"ease":"Power2.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'
                                data-x="center" data-y="center" data-voffset="['100','100','100','100']"
                                data-fontsize="['18','18','18','35']" data-lineheight="['100','100','100','100']"
                                style="color: #b5b5b5;">
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="height: 100px; width: 100%; border: 1px red solid;">
                            ...
                            <!-- <a class="tp-caption btn btn-primary font-weight-bold" href="#"
                                ...
                                data-x="center" data-hoffset="0" data-y="center" data-voffset="['70','70','70','135']"
                                data-paddingtop="['15','15','15','30']" data-paddingbottom="['15','15','15','30']"
                                data-paddingleft="['40','40','40','57']" data-paddingright="['40','40','40','57']"
                                data-fontsize="['13','13','13','25']" data-lineheight="['20','20','20','25']">GET
                                STARTED NOW <i class="fas fa-arrow-right ml-1"></i></a> -->
