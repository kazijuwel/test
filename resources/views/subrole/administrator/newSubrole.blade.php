...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
      ...
      <form method="post" action="{{ route('administrator.subroleSave', $subrole) }}">
        
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">
              <i class="fa fa-edit"></i> Create New Member for Company: {{ $company->title }}
            </h3>
          </div>
              ...
              <div class="col-sm-6">
                          ...
                          <div class="card-body">
                            ...
                            {{-- <div class="form-group has-feedback{{ $errors->has('user') ? ' has-error' : '' }}"> --}}
                              ...
                              <div class="input-group mb-3">
                                ...
                                style="">
                                @if($subrole->user)
                                <option value="{{ $subrole->user_id }}">{{ $subrole->user->mobileOrEmail() }}</option>
                                @endif
                              </select>
                ...
                <div class="card-body" style="min-height: 200px;">
                  ...
                  <div class="form-group">
                    ...
                    {{-- <input type="text" name="title" class="form-control" placeholder="Enter Role Name"   value="{{ old('title') ?: $subrole->title }}"  id="title"> --}}
        ...
        <div class="card-footer bg-white">
          ...
          <div class="float-right">
            ...
            <button type="submit" class="btn btn-primary">Create Subrole</button>
          </div>
        </div>
      </div>
    </form>
