      ...
      <div class="col-sm-12">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">
              All @if(isset($type)) {{ucfirst($type)}}@endif Devices Data of {{ $subrole->title }}
            </h3>
            ...
            <tbody class="w3-small"> 
              ...
              @foreach ($settingDatas as $sd)
                <tr class="nowrap">
                  ...
                  <td>
                    <a target="_blank" class="btn btn-xs btn-primary w3-tiny  py-0" href="{{ route('subrole.singleDeviceSingleDataDetails', ['subrole'=>$subrole, 'data'=>$sd]) }}">Battery Details</a>
                  </td>
                  @elseif($sd->product->type == 'rectifier')
                  <td>
                    <a target="_blank" class="btn btn-xs btn-primary w3-tiny  py-0" href="{{ route('subrole.singleDeviceSingleDataDetails', ['subrole'=>$subrole, 'data'=>$sd]) }}">Rectifier Details</a>
                  </td>
                  @endif
                  <td>
                    {{ $sd->updated_at }}
