            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        <span class="badge badge-default">Macid: {{ $product->macid }},Type: {{ucfirst($product->type)}}
                            Title: {{ $product->title }} ({{ $sd->updated_at }})</span>
                                ...
                                <div class="card-body p-1">
                                    <table class="table table-striped table-sm table-hover w3-small table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Zone</th>
                                                <td>{{$sd->productLocationData ? $sd->productLocationData->zone : ''}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Region</th>
                                                <td> {{$sd->productLocationData ? $sd->productLocationData->region : ''}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Lat</th>
                                                <td> {{$sd->productLocationData ? $sd->productLocationData->lat : ''}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Lng</th>
                                                <td> {{$sd->productLocationData ? $sd->productLocationData->lng : ''}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Location</th>
                                                <td> {{$sd->productLocationData ? $sd->productLocationData->location : ''}}
                                                </td>
                                            </tr>
                                ...
                                <div class="card-body p-1">
                                    ...
                                    <table class="table table-striped table-sm table-hover w3-small table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Device ID/EMEI</th>
                                                <td>{{$sd->macid}}</td>
                                            </tr>
                                            <tr>
                                                <th>Device Plate Number</th>
                                                <td>{{$sd->productData->platenumber}}</td>
                                            </tr>
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w3-center">{!! date("Y-m-d h:i:s",$ad->send_time/1000) !!}
                                                </td>
                                                ...
                                                <td class="w3-center">
                                                    <a href="{{route('company.hideValue',['company'=>$company, $ad->id])}}"
                                                        class="btn btn-xs btn-default">Hide</a>
                                                </td>
                ...
                @keyframes animate {
                  ...
                  @endif
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($sd->productData->BatteryA <0) <span
                                                        class="badge badge-danger">Discharging</span>
                                                        @else
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($sd->productData->BetteryA<0) <span class="badge badge-success">
                                                        Discharging...</span>
                                                        @endif
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>{{ $sd->productData->RemainingCapacity }} mAH</td>
                                            </tr>
                                            <tr>
                                                <th>Full Capacity</th>
                                                <td>{{ $sd->productData->FullCapacity }} mAH</td>
                                            </tr>
                                            <tr>
                                                <th>Design Capacity</th>
                                                <td>{{ $sd->productData->DesignCapacity }} mAH</td>
                                            </tr>
                                            <tr>
                                                <th>MOS Temp</th>
                                                <td>{{ $sd->productData->MosTemperature }} °C</td>
                                            </tr>
                                            <tr>
                                                <th>ENV Temp</th>
                                                <td>{{ $sd->productData->EnvironmentTemperature }} °C</td>
                                            </tr>
                                            <tr>
                                                <th>Version</th>
                                    ...
                                    <div class="w3-responsive">
                                        <table class="table table-striped table-sm table-hover w3-small table-bordered">
                                            ...
                                            <tr>
                                                <th>Batt1Curr:</th>
                                                <td>
                                                    @if($ib1cap = $rect->productRectitems()->where('comment',
                                                    'Batt1Curr')->first())
                                            ...
                                            <tr>
                                                <th>Temp2</th>
                                                <td>@if($ib1cap = $rect->productRectitems()->where('comment',
                                                    'Temp2')->first())
                                                    {{$ib1cap->array_value}} °C
                                                    @endif </td>
                                            </tr>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped table-sm table-hover w3-small table-bordered">
                                        <tbody>
                                            <tr>
                                                <th>Refresh Time</th>
                                                <td>{!!date('Y-m-d h:i:s',strtotime($rect->dcSettingUpdateTime))!!}</td>
                                            </tr>
                                            <tr>
                                                <th>DC OverVolt</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($ibfn = $rect->productRectitems()->where('comment', 'Batt Fuse
                                                    Num')->first())
                                                    {{$ibfn->array_value}} mA
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                <th>Batt1TH</th>
                                                <td>@if($ib1th = $rect->productRectitems()->where('comment',
                                                    'Batt1TH')->first())
                                                    {{$ib1th->array_value}} °C
                                                    @endif</td>
                                            </tr>
                                            <tr>
                                                <th>Batt1TH+</th>
                                                <td>
                                                    @if($ib1th = $rect->productRectitems()->where('comment',
                                                    'Batt1TH+')->first())
                                                    {{$ib1th->array_value}} °C
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                <th>Batt2TH</th>
                                                <td>@if($ibfn = $rect->productRectitems()->where('comment',
                                                    'Batt2TH')->first())
                                                    {{$ibfn->array_value}} °C
                                                    @endif</td>
                                            </tr>
                                            <tr>
                                                <th>Batt2TH+</th>
                                                <td>
                                                    @if($ibfn = $rect->productRectitems()->where('comment',
                                                    'Batt2TH+')->first())
                                                    {{$ibfn->array_value}} °C
                                                    @endif
                                                </td>
                    ...
                    <iframe class="w3-card w3-round" width="100%" height="450" frameborder="0" scrolling="no"
                        marginheight="0" marginwidth="0"
                        src="https://maps.google.com/maps?q={{ $sd->productLocationData ? $sd->productLocationData->lat : '' }},{{ $sd->productLocationData ? $sd->productLocationData->lng : '' }}&amp;output=embed"></iframe><br />
