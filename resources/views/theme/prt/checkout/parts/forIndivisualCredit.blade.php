        ...
        <div class="card card-default">
            ...
            <div id="collapseOne" class="collapse show">
                <div class="card-body ">
                    ...
                    <form action="{{ route('user.checkoutCreditPost') }}"
                        method="post" id="frmBillingAddress">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col">
                                <label class="font-weight-bold text-dark text-2">Credit Amount</label>
                                <input type="number" step="0.01" min="0" value="" name="credit" id="credit" class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col">
    ...
    <table class="cart-totals">
        <tbody>
            ...
            <tr class="total">
                ...
                <td>
                    <strong class="text-dark" style="font-size: 11px !important;"><span class="amount" id="totalamount">£
                        </span></strong>
                </td>
            </tr>
        </tbody>
