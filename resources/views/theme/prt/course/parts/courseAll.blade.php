...
<div class="container py-2 mt-2">
    ...
    <div class="row mt-2 pt-3 mb-5 pb-3">
        ...
        <div class="col-md-4 col-lg-3 col-sm-2 mb-5 mb-1 appear-animation w3-border-top" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">

            <div class="w3-card- card- mt-3 w3-round-large- w3-hover-shadow " style="height: 380px; position: relative; border: 1px solid black">
              <a href="{{route('welcome.courseDetails',$course)}}">
                ...
                <div class="card-body p-2">
                  <a href="{{route('welcome.courseDetails',$course)}}">
                    ...
                    <p class="card-text text-dark">{{custom_title($course->excerpt,70)}}</p>
                  </a>
                ...
                <div class="w3-blue w-100 p-2 d-flex justify-content-between" style="border-radius: 0px 0px 0px 0px; position: absolute; bottom: -0px;">
                  {{-- <span class="text-white h5 m-0">{{ $course->topics->count() }} Lessons</span> --}}
                  <span class="text-white h5 m-0"><a href="{{route('welcome.courseDetails',$course)}}" class="read-more text-color-white font-weight-semibold text-2 text-center">read more <i class="fas fa-angle-right position-relative top-1 ml-1"></i></a></span>
                  <span class="w3-text-aqua"> {{ $course->course_credit ? ' £'.$course->course_credit : 'Free' }}</span>
                </div>
            </div>
        </div>
        @endforeach
