            ...
            <div class="accordion" id="accordion12">
                <div class="card card-default">
                    <div class="card-header" id="collapse12HeadingOne">
                        <h4 class="card-title m-0">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapse12One"
                                aria-expanded="true" aria-controls="collapse12One">
                                Passanger Information
                            </a>
                        </h4>
                    </div>
                    <div id="collapse12One" class="collapse show" aria-labelledby="collapse12HeadingOne"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="w3-row">
                                                ...
                                                <div class="w3-col s4">
                                                    <select required
                                                        class="form-control @error('nday') is-invalid @enderror"
                                                        value="{{ old('nday') }}" id="day" name="nday">

                                                        @if (old('nday'))
                                                            <option selected value="{{ old('nday') }}">
                                                                {{ old('nday') }}</option>
                                                        @else
                                                ...
                                                <div class="w3-col s4">
                                                    <select required
                                                        class="form-control @error('nmonth') is-invalid @enderror"
                                                        id="month" name="nmonth" value="{{ old('nmonth') }}">

                                                        @if (old('nmonth'))
                                                            {{-- <option selected value="{{old('nmonth')}}">{{old('nmonth')}}</option> --}}
                                                            @if (old('nmonth') == '01')
                                                                <option selected value="01">January</option>
                                                            @elseif(old('nmonth') == "02")
                                                                <option selected value="02">February</option>
                                                            @elseif(old('nmonth') == "03")
                                                                <option selected value="03">March</option>
                                                            @elseif(old('nmonth') == "04")
                                                                <option selected value="04">April</option>
                                                            @elseif(old('nmonth') == "05")
                                                                <option selected value="05">May</option>
                                                            @elseif(old('nmonth') == "06")
                                                                <option selected value="06">Jun</option>
                                                            @elseif(old('nmonth') == "07")
                                                                <option selected value="07">July</option>
                                                            @elseif(old('nmonth') == "08")
                                                                <option selected value="08">August</option>
                                                            @elseif(old('nmonth') == "09")
                                                                <option selected value="09">September</option>
                                                            @elseif(old('nmonth') == "10")
                                                                <option selected value="10">October</option>
                                                            @elseif(old('nmonth') == "11")
                                                                <option selected value="11">November</option>
                                                            @elseif(old('nmonth') == "12")
                                                ...
                                                <div class="w3-col s4">
                                                    <select required
                                                        class="form-control @error('nyear') is-invalid @enderror"
                                                        value="{{ old('nyear') }}" id="year" name="nyear">

                                                        @if (old('nyear'))
                                                            <option selected value="{{ old('nyear') }}">
                                                                {{ old('nyear') }}</option>
                                                        @else
                ...
                <div class="card card-default">
                    <div class="card-header" id="collapse12HeadingTwo">
                        <h4 class="card-title m-0">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapse12Two"
                                aria-expanded="false" aria-controls="collapse12Two">
                                Identification Details (Optional)
                            </a>
                        </h4>
                    </div>
                    <div id="collapse12Two" class="collapse" aria-labelledby="collapse12HeadingTwo"
                        data-parent="#accordion12">
                        <div class="card-body">
