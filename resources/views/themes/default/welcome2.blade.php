                            ...
                            <div class="grid-card-contact py-2">
                                ...
                                <div>
                                    @if ($user->isPending())
                                        ...
                                        <a class="btn btn-rounded card-text py-2 " style="border: 1px solid gray" href="{{$me->isValidate() ? ""  : url('/packages')}}" data-toggle={{$me->isValidate() ? "modal" : ""}} data-target="#feature_largeModal{{$user->id}}"> <i class="fas fa-check-circle"></i></a> <br>
                                    ...
                                    @elseif($user->isMyPending())
                                        ...
                                        <a class="btn btn-rounded card-text py-2 " style="border: 1px solid gray" href="{{$me->isValidate() ? ""  : url('/packages')}}" data-toggle={{$me->isValidate() ? "modal" : ""}} data-target="#feature_largeModal{{$user->id}}"> <i class="far fa-window-close"></i></a> <br>
...
{{-- {{dd($me->isValidate())}} --}}
                                ...
                                <div>
                                    ...
                                    <a class="card-text py-2 w3-hover-text-blue pl-3 w3-round-xlarge" href="{{route('user.profile', $user->id)}}">More...</a></div>
                ...
                <div class="col-md-12 text-center pt-1">
                    <a href="{{ $me->isValidate() ? route('featureProfiles') : url('/packages') }}" class="btn btn-light text-danger">See More</a>
                </div>
