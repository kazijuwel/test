                ...
                <form id="newsletterForm" action="php/newsletter-subscribe.php" method="POST" class="mr-4 mb-3 mb-md-0">
                    <div class="input-group input-group-rounded">
                        <input class="
                                ...
                                bg-light
                            " placeholder="Email Address" name="newsletterEmail" id="newsletterEmail" type="text" />
            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                <div class="contact-details">
                    ...
                    <ul class="list list-icons list-icons-lg">
                        ...
                        <a href="{{ route('page',$page->route_name) }}">{{$page->page_title}}</a> <br>
            ...
            <div class="row py-4">
                <div class="
                    ...
                    <a href="{{url('/')}}" class="logo pr-0 pr-lg-3">
                        <img alt="Porto Website Template" src="{{ asset('img/logo.png') }}" class="opacity-5"
                            height="33" />
                    </a>
                </div>
                <div class="
                ...
                <div class="
                    ...
                    <nav id="sub-menu">
                        <ul>
                            <li>
                                <i class="fas fa-angle-right"></i><a href="page-faq.html" class="
                                        ml-1
                            ...
                            <li>
                                <i class="fas fa-angle-right"></i><a href="sitemap.html" class="
                                        ml-1
                                        text-decoration-none
                                    ">
                                    Sitemap</a>
                            ...
                            <li>
                                <i class="fas fa-angle-right"></i><a href="contact-us.html" class="
                                        ml-1
                                        text-decoration-none
                                    ">
                                    Contact Us</a>
