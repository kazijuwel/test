...
<div class="container py-4 bg-white" >
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="color-vipmm2">Search Result </h4>
                </div>

                @if($users->count() == 0)
                <div class="w3-panel w3-pale-red w3-card w-75 p-1">
                    <p class="text-dark">No Users Matching..</p>
                </div>
                @endif
                           ...
                           <div class="col-7">
                            ...
                            <div class="grid-card-contact py-2">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-rounded card-text py-2 " style="border: 1px solid gray" href="{{$me->isValidate() ? route('user.messageDashboard', $user->id)  : url('/packages')}}" > <i class="icon-envelope icons"></i></a> <br>
