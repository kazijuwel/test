...
<div class="static-container">
    <div class="static">
        <h1>Privacy Policy for QueAns</h1>

        <p>At QueAns, accessible from www.queans.min.mx, one of our main priorities is the privacy of our visitors. This
            Privacy
            Policy document contains types of information that is collected and recorded by QueAns and how we use it.
        </p>

        <h2>Log Files</h2>

        <p>QueAns follows a standard procedure of using log files. These files log visitors when they visit websites.
            All
        ...
        <p>Like any other website, QueAns uses 'cookies'. These cookies are used to store information including
            visitors'
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of QueAns.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in
            their respective advertisements and links that appear on QueAns, which are sent directly to users' browser.
            They
        ...
        <p>Note that QueAns has no access to or control over these cookies that are used by third-party advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>QueAns's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
            the
        ...
        <p>QueAns does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
            you
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to
            the information that they shared and/or collect in QueAns. This policy is not applicable to any information
