...
---------------------------------------------------
About Page
Displays the information about the website
---------------------------------------------------
*/
@endphp
...
<div class="static-container">
    <div class="static">
        ...
        <p>Welcome to QueAns!</p>

        <p>These terms and conditions outline the rules and regulations for the use of QueAns's Website, located at
            www.queans.min.mx.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use QueAns if
            you do
        ...
        <p>We employ the use of cookies. By accessing QueAns, you agreed to use cookies in agreement with the QueAns's
            Privacy
            Policy. </p>
        ...
        <p>Unless otherwise stated, QueAns and/or its licensors own the intellectual property rights for all material on
            QueAns.
            All intellectual property rights are reserved. You may access this from QueAns for your own personal use
            subjected
            to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from QueAns</li>
            <li>Sell, rent or sub-license material from QueAns</li>
            <li>Reproduce, duplicate or copy material from QueAns</li>
            <li>Redistribute content from QueAns</li>
        </ul>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas
            of the website. QueAns does not filter, edit, publish or review Comments prior to their presence on the
            website.
            Comments do not reflect the views and opinions of QueAns,its agents and/or affiliates. Comments reflect the
            views
        ...
        <p>QueAns reserves the right to monitor all Comments and to remove any Comments which can be considered
            inappropriate,
        ...
        <p>You hereby grant QueAns a non-exclusive license to use, reproduce, edit and authorize others to use,
            reproduce and
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            records
            with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of QueAns; and
            (d) the
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you
            must inform us by sending an e-mail to QueAns. Please include your name, your organization name, contact
            information
            as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list
            of the
        ...
        <p>No use of QueAns's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
