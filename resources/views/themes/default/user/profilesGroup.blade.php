                           ...
                           <div class="col-7">
                            ...
                            <div class="grid-card-contact py-2">
                                <div>
                                    ...
                                    <a class="btn btn-rounded card-text py-2" style="border: 1px solid red" href="{{ route('user.removeFavourite', $user) }}"> <i class="icon-heart icons text-danger font-weight-bold"></i> </a> <br>
                                    <span style="white-space:nowrap; font-size:9px"> Unfavourite</span>

                                    @else
                                    <a class="btn btn-rounded card-text py-2 " style="border: 1px solid gray" href="{{ route('user.removeFavourite', $user) }}"> <i class="icon-heart icons"></i> </a> <br>
                                ...
                                <div>
                                    @if ($user->isPending())
                                        ...
                                        <a class="btn btn-rounded card-text py-2 " style="border: 1px solid gray" href="" data-toggle="modal" data-target="#feature_largeModal{{$user->id}}"> <i class="fas fa-check-circle"></i></a> <br>
                                        <span style="white-space:nowrap; font-size:9px">Accept
                                            Proposal</span>
                                    @elseif($user->isMyPending())
                                        <a class="btn btn-rounded card-text py-2 " style="border: 1px solid gray" href="" data-toggle="modal" data-target="#feature_largeModal{{$user->id}}"> <i class="far fa-window-close"></i></a> <br>
                                        <span style="white-space:nowrap; font-size:9px">Cancel
                                            Proposal</span>
                                    @elseif($user->isConnected())
                                    <a class="btn btn-rounded card-text py-2 " style="border: 1px solid gray" href="{{ route('user.messageDashboard', $user->id) }}" > <i class="icon-envelope icons"></i></a> <br>
                                    <span style="white-space:nowrap; font-size:9px"> Send
                                        Message</span>
                                    @else
                                    <a class="btn btn-rounded card-text py-2 " style="border: 1px solid gray" href="" data-toggle="modal" data-target="#feature_largeModal{{$user->id}}"> <i class="icon-cursor icons"></i></a> <br>
                                    <span style="white-space:nowrap; font-size:9px"> Send
                                        Proposal</span>
