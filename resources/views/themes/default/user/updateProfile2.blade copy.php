        ...
        <div class="col-lg-9">
            ...
            <form action="{{ route('profilePost',$user->id) }}" role="form" method="POST" class="needs-validation"
                ...
                <div class="form-group row">
                    <label
                        class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Date of Birth</label>
                    <div class="col-lg-9">
...
{{--
                ...
                <h5 class="text-center">Parmanent Address</h5>
                <div class="form-group row">
                    <label
                        class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2 required">Division</label>
                    <div class="col-lg-9">
                ...
                <h5 class="text-center">Physical Attribute</h5>
                ...
                <h5 class="text-center">Favourite List</h5>
                <div class="form-group row">
                    <label
