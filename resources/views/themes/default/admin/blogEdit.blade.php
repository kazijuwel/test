                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="excerpt" class="form-control" rows="3" id="excerpt"
                                        placeholder="Excerpt of Post">{{ old('excerpt') ?: $post->excerpt }}</textarea>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <img class="img-fluid" src="{{asset('storage/media/image/'. $post->feature_img_name)}}" alt="">
                                <div class="w3-display-topright" style="padding-right: 10px;padding-top: 10px;">
                                  <a class="btn btn-primary btn-xs"  href="{{route('admin.featureImageDelete',$post)}}" onclick="return confirm('Are you sure?')"><i class="fa fa-times"></i></a>
                                </div>
