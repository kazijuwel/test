...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card bg-white my-4 py-2">
                <div class="card-body">
                    <form class="form-horizontal " role="form" method="post"
                        ...
                        <div class="row px-3">
                            <div class="col-sm-6">
                                ...
                                <div
                                    class="form-group row form-group-sm {{ $errors->has('paid_currency') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="paid_currency"
                                                    id="exampleRadios1" value="BDT" {{ $payment->paid_currency == 'BDT'
                                                ? 'checked' : '' }} /> BDT
                                                <span class="circle">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="paid_currency"
                                                    id="exampleRadios2" value="USD" {{ $payment->paid_currency == 'USD'
                                                ? 'checked' : '' }} /> USD
                                                <span class="circle">
                                                    <span class="check"></span>
                                                </span>
