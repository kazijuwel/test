<div class="box box-widget mb-1">
	<div class="box-body">
		...
		<div class="text-right">
			...
			<a class="btn w3-btn btn-xs btn-primary" target="_blank"
				href="{{ route('page',$page->route_name) }}">Preview Page</a> &nbsp;

			<a class="w3-btn btn-primary btn btn-xs " href="{{ route('admin.pageEdit', $page) }}">Page Edit</a>
			&nbsp;
			<a class="w3-btn btn-primary btn btn-xs " href="{{ route('admin.pageItems', $page) }}">Add Page Part</a>
