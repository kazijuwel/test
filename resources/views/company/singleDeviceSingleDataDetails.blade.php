        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <div class="card card-widget">
              ...
              {{-- <dl class="row">
                  <dt class="col-sm-7">Grid Power</dt>
                  <dd class="col-sm-5"><i class="fa fa-circle w3-text-green"></i></dd>
            ...
            <div class="card card-widget">
              ...
              <div class="card-body p-1">
                ...
                <table class="table table-striped table-sm table-hover w3-small table-bordered">
                  <tbody>
                  {{-- <tr><th>Device Serial</th> <td></td></tr> --}}
            ...
            <div class="card card-widget">
              ...
              <table>
                ...
                <tbody>
                  ...
                  <td class="w3-center">
                    <a href="{{route('company.hideValue',['company'=>$company, $ad->id])}}" class="btn btn-xs btn-default">Hide</a>
                  </td>
