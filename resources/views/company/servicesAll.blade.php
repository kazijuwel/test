      ...
      <div class="col-sm-12">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">
              All @if(isset($status)) {{ucfirst($status)}} @endif @if(isset($type)) {{ucfirst($type)}} @endif Devices ({{ count($items) }}) of {{ $company->title }}
            </h3>
            ...
            <div class="card-tools">
              ...
              <button class="btn btn-sm btn-light float-right" onclick="exportTableToCSV('{{$fn}}')">Export To CSV</button>
                ...
                <form action="{{ route('company.deviceSearch',$company) }}" class="float-right mr-3 mt-1">
            ...
            @include('company.includes.productsAll')
