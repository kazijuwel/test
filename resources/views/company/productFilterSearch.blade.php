...
@section('content')
  <section class="content">
    ...
    <form action="{{route('company.Search', ['company'=>$company,'type'=>$type])}}">
        ...
        <div class="col-sm-12">
            ...
            <div class="card-body">
                ...
                <div class="form-group clearfix">
                    ...
                    <div class="span badge">
                        <div class="icheck-primary d-inline">
                            <input type="checkbox"  {{in_array('SiteName',$filter) ? 'checked' : ''}} value="SiteNameLive" name="filter[]"  class="checkboxPrimary3">
                            <label>
                            SiteNameLive
                            </label>
                        </div>
    ...
    <!-- /.form -->
            ...
            <div class="col-sm-12">
                <div class="card">
                                    ...
                                    <?php $i = (($items->currentPage() - 1) * $items->perPage() + 1); ?>
                                        ...
                                        @foreach ($items as $item)
                                            ...
                                            <tr class="nowrap">
                                                ...
                                                <td>{{$i}}</td>
                                                <td>
                                                    <a target="_blank" class="btn btn-xs btn-primary w3-tiny no-print  py-0" href="{{ route('company.singleDeviceSingleDataDetails', ['company'=>$company, 'data'=>$item]) }}">Details</a>
                                                </td>
                                                ...
                                                @foreach($filter as $f)
                                                    ...
                                                    @if($f == 'SiteName')
                                                        ...
                                                        @elseif($f == 'SiteNameLive')
        
                                                        <td>{{$item->productData->title_live}}</td>
                    ...
                    {{$items->appends([ 'pages'=> $pages,'macids' => $macids, 'filter'=>$filter, 'from'=>$from,'to'=>$to, 'type' => isset($type) ? $type : null])->render()}}
