            ...
            <div class="card">
                ...
                <div class="card-body" >
                    <form action="{{ route('minimum_delivery_charge') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-from-label" for="title" style="padding-top: 10px;">{{translate('Minimum Delivery Charge(In Dhaka)')}}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-from-label" for="title" style="padding-top: 10px;">{{translate('Minimum Delivery Charge(Out of Dhaka))')}}</label>
                            <div class="col-sm-8">
                                <input type="text" placeholder="" id="" name="outside_minimum_charge" class="form-control" value="{{$min_charge->outside_minimum_charge}}" required>
                            </div>
                        </div>
