        ...
        <div class="card-body">
            <form action="{{ route('supplier.store') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{translate('Mobile')}}" id="text" name="mobile" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="address">{{translate('Address')}}</label>
                    <div class="col-sm-9">
                        <textarea name="address" id="address" class="form-control" required cols="30" rows="3"></textarea>
                    </div>
                </div>
