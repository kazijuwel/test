                        ...
                        <div class="aiz-topbar-item ml-2">
                            <div class="align-items-stretch d-flex dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-xs">
                                    <a href="{{ route('supplierPayment',$seller) }}"  class="dropdown-item">
                                        {{translate('Supplier Payments')}}
                                      </a>
                                    <a href="{{ route('supplierProductStock',$seller) }}"  class="dropdown-item">
                                        {{translate('Supplier Product Stock')}}
                                      </a>


                                    <a href="{{ route('adminsellerview',$seller->user_id) }}"  class="dropdown-item">
                                      {{translate('Profile')}}
                                    </a>
