<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin_dashboard') }}" class="d-block text-left">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                <li class="aiz-side-nav-item">
                    <a href="{{route('admin_dashboard')}}" class="aiz-side-nav-link">
                        ...
                        <!-- <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('product_bulk_upload.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Bulk Product Upload') }}</span>
                                </a>
                            </li>
                        <!-- <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('bulk_category')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['bulk_category', 'categories.create', 'categories.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Bulk Category Commission')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a class="aiz-side-nav-link" href="{{ route('service_customer.application') }}">
                            <span class="aiz-side-nav-text">{{translate('Customer request')}}</span>
                        </a>
                    </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('service_provider.application') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('service provider') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('service_orderplacing.application') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('service order placing') }}</span>
                                </a>
                            </li>
        ...
        @endif
            ...
            <!-- Sale -->
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('adminActivitylogs') }}"
            ...
            <!-- Sellers  and Suppliers-->
                @if((Auth::user()->user_type == 'admin' || in_array('9', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Sellers & Suppliers') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('supplier.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['supplier.index','supplier.edit','supplier.update'])}}">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('withdraw_requests_all') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Seller Payment Requests') }}</span>
                                </a>
                            </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('MIS Report') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.report') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('All Order Report') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('sellers.mis_report') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Seller Payment Status')}}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('sellers.payment_histories') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Receive and Payment Report') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('refund_report') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Refund Report') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders_delivery_status') }}" class="aiz-side-nav-link">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-file-alt aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Trading Part') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('salesinvoice') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Sales Invoice') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('salesorders') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('All Orders Status')}}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('salesreturn') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Sales Return') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('salesdelivery') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Sales Delivery') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('salesreport') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Order Wise Sales') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('salesreportorderitemwise') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Order item Wise Sales') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('balancesheet') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Income Statement') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('balanceinvoice') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Income Statement Invoice') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.expensetype') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Expense Type') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('expenseStatement') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate(' Expense Statement')}}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-file-alt aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Financial Part') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        {{-- <li class="aiz-side-nav-item">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('salesorders') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Sales Orders')}}</span>
                            </a>
                        </li>
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('directOrderChage') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Order Change')}}</span>
                            </a>
                        </li>
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('Journal_entries') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Journal')}}</span><span class="badge badge-primary px-2" style="    width: 28px;">New</span>
                            </a>

                        </li> --}}

                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('chatof_Accounts') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Chat of Accounts')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                            </a>
                        </li> --}}
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('Summary_accounts') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Summary')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                            </a>
                        </li> --}}
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('chatof_Accounts_modify') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Chat of Accounts')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                            </a>
                        </li> --}}
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('allvoucherlist') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Journal(Voucher)Entry')}}</span><span class="badge badge-primary px-2" style="    width: 28px;">New</span>
                            </a>

                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('managechartofaccouts') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Chart of Accounts')}}</span><span class="badge badge-primary px-2" style="    width: 28px;">New</span>
                            </a>

                        </li>
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('voucher_entries_modify') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Journal(Voucher)Entry')}}</span><span class="badge badge-primary px-2" style="    width: 28px;">New</span>
                            </a>
                        ...
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('voucher_entries') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Journal Entries')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                            </a>
                        </li> --}}
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('accounts_Report') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Acconts Reports')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('inventory') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Inventory')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('belaobelajournal') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('belaobela journal')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            {{-- <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link">
                    <i class="las la-file-alt aiz-side-nav-icon"></i>
                    <span class="aiz-side-nav-text">{{ translate('Expense') }}</span>
                    <span class="aiz-side-nav-arrow"></span>
                </a>
                <ul class="aiz-side-nav-list level-2">
                    <li class="aiz-side-nav-item">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('salesorders') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('Add Expense')}}</span>
                        </a>
                    </li>
            ...
            <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link">
                    <i class="las la-file-alt aiz-side-nav-icon"></i>
                    <span class="aiz-side-nav-text">{{ translate('Inventory & Purchases') }}</span>
                    <span class="aiz-side-nav-arrow"></span>
                </a>
                <ul class="aiz-side-nav-list level-2">

                    <li class="aiz-side-nav-item">
                        <a href="{{ route('all_store_list') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('All Store')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                        </a>
                    </li>
                    {{-- <li class="aiz-side-nav-item">
                        <a href="{{ route('allinventoryshow') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('All Inventory')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                        </a>
                    </li> --}}
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('allcontianers') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('Ad Containers')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('all_add_items') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('Ad Items')}}</span><span class="badge badge-primary px-2" style="width: 28px;">New</span>
                        </a>
                    </li>
            ...
            <!-- Job Corner -->
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <!-- <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="lab la-black-tie aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Job Corner') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="#" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Job Circular') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{route('jobs.internship.application')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Internship Application')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('jobs.join.application') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['customer_packages.index', 'customer_packages.create', 'customer_packages.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Join Application') }}</span>
                                </a>
                            </li>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('purchaseReport') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['purchaseReport'])}}">
            ...
            <!-- marketing -->
                @if(Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                    <a href="{{ route('email_sms_setup') }}"
                                       class="aiz-side-nav-link {{ areActiveRoutes(['email_sms_setup'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Auto Email & SMS Setup') }}</span>
                                    </a>
                                </li>
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('flash_deals.index') }}"
                                       class="aiz-side-nav-link {{ areActiveRoutes(['flash_deals.index', 'flash_deals.create', 'flash_deals.edit'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Flash or Stock deals') }}</span>
                                    </a>
                                </li>
                                ...
                                @if (\App\Addon::where('unique_identifier', 'otp_system')->first() != null && \App\Addon::where('unique_identifier', 'otp_system')->first()->activated)
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('sms.index')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Bulk SMS') }}(customer)</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('sms.seller')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Bulk SMS') }}(seller)</span>
                                        </a>
                                    </li>
                                @endif
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('12', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('contuct_us.application') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Contact Us List') }}</span>
                                </a>
                            </li>
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('conversations.admin_index') }}"
                                       class="aiz-side-nav-link {{ areActiveRoutes(['conversations.admin_index', 'conversations.admin_show'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Conversation')}}</span>
            ...
            <!-- Setup & Configurations -->
                @if(Auth::user()->user_type == 'admin' || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <!-- <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('delivery_method_configuration.index')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['delivery_method_configuration.index'])}}">
                                    <span class="aiz-side-nav-text"><nobr>{{translate('Delivery Method Configuration')}}</nobr></span>
                                </a>
                            </li>
                        <!-- <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-dharmachakra aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">Delivery Man</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{route('deliveryMan.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('All Delivery Man')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('deliveryMan.create')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Create Delivery Man')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('daily_order_summery')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Daily Order Summary')}}</span>
                            </a>
                        </li>
            ...
            <!-- Staffs -->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('20', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="<i lab la-wpforms aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('POP UP')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('popup.create') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['popup.create'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Add New Pop Up')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('popup.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['popup.index','popup.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Pop Up List')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('survey_popup.index')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['survey_popup.index','survey_popup.view'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Customer Query')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
