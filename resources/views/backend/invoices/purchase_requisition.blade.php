        ...
        <table class="table" style="border:none">
            ...
            <tr style="border:none">
                ...
                <td style="border:none; text-align:left;float:right;width:30%;vertical-align: text-top;" >
                    <h3 style="font-size: 1.3rem;padding-left: 50px;margin-bottom:15px" class="text-center strong">Purchase <br>Requisition</h3>
                    ...
                    <p class=" small" style="left:0px"><strong><span class="small">INVOICE NO:</span></strong> <span class="strong">{{ $order->code }}</span></p>
        ...
        <table class="table" style="border:none;margin-bottom:5px; margin-top:20px" >
            ...
            <tr style="border:none">
                ...
                <td  style="border:none;text-align:left; width:30%;">
                    ...
                    <p style="left:0px">Seller Name: {{ $sellerData->name }}</p>
                    <p style="left:0px">Company Name: {{$sellerData->shop?$sellerData->shop->name: "" }}</p>
                    ...
                    <p style="left:0px">Phone Number: {{ $sellerData->phone }}</p>
                    <p style="left:0px">Email: {{ $sellerData->email }}</p>
                ...
                <td style="border:none; text-align:left; float:right;width:30%;"></p>
                    <p style="font-size:17px; font-weight: 600;border-bottom: 1px solid #ddd;">For</p>
    ...
    <div style="padding: 1rem;">
        <table class="small border-bottom" style="border:1px solid #ddd;margin-top:-15px !important;">
            ...
            <tr >
                ...
                <th style="text-align: right;background-color:#f16522 !important;color:#ffffff;">PURCHASE PRICE</th>
            ...
            @foreach ($orderDetails as $key => $orderDetail)
                ...
                @if ($orderDetail->product != null)
                    <tr>
                        ...
                        <td style="text-align: right;padding-right:5px;">{{ single_price($orderDetail->purchase_price) }}</td>
                        <td style="text-align: right;padding-right:5px;">
                            @php

                                $totalPrice += $orderDetail->purchase_price * $orderDetail->quantity
                            @endphp

                            {{ single_price($orderDetail->purchase_price * $orderDetail->quantity ) }}
        ...
        <table class="table" style="border:none;">
            ...
            <tr>
                ...
                <td style="text-align: right;border:none;width:20% ">
                   {{-- <p style="border-bottom: 1px solid #776e6e;">{{ single_price($order->orderDetails->sum('purchase_price') + $order->orderDetails->sum('commision')+$order->orderDetails->sum('shipping_cost')) }}</p>--}}
                    ...
                    <p style="border-bottom: 1px solid #000000;">{{ single_price($totalPrice) }}</p>
            ...
            {{--<tr>
                <td colspan="3" style="text-align: right;border:none;width:20% "><p style="font-weight: 600; padding-top:7px">Amount in Word: <span style="border-bottom: 1px solid #000000;">Two thousand four hundred taka only</span></p></td>
            </tr>--}}
