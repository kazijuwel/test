...
<div>
    ...
    <div style="background: #ffffff;padding: 1rem;">
        ...
        <table class="table" style="border:none;margin-bottom:5px; margin-top:20px">
            ...
            <tr style="border:none">
                ...
                <td  style="border:none;text-align:left; width:30%;">
                    ...
                    <p style="left:0px">Company Name: {{$sellerData->shop? $sellerData->shop->name:null }}</p>
        ...
        <table class="small border-bottom mt-2" style="border:1px solid #ddd;margin-top:-15px !important;">
