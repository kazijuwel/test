    ...
    .profile-user-img {
        ...
        <section class="content">
            <div class="container-fluid">
                  ...
                  <div class="card card-primary card-outline bg-primary">
                    <div class="card-body box-profile">
                      <div class="text-center">
                          @if($customerDetails->avatar_original  != null)
                            <img class="profile-user-img img-fluid img-circle"
                            src="{{ uploaded_asset($customerDetails->avatar_original) }}"
              ...
              <div class="row">
                  <div class="col-md-12">
                    <p class="bg-warning p-2">Orders</p>
                    ...
                    <table class="table table-hover table-bordered table-striped table-sm" style="white-space: nowrap">
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <td class="text-center">
                                {{single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('commision'))}}
