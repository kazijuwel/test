		...
		<div class="card">
			...
			<div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="custom_product_slug" placeholder="{{translate('Custom Product Slug')}}" value="{{ $product->slug_2 }}" id="custom_product_slug">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Delivery Free')}}</label>
                    <div class="col-lg-8">
                        <label class="aiz-switch aiz-switch-success mb-0" style="margin-top:5px;">
                            <input type="checkbox" name="delivery_free" @if ($product->delivery_free == true) checked @endif>
		...
		<div class="col-12">
                <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                    <div class="btn-group mr-2" role="group" aria-label="Third group">
                        <button type="submit" name="button" class="btn btn-info savesfkj"> {{ translate('Save') }}</button>
                    </div>
                    @if($product->published == 0)
                    <div class="btn-group" role="group" aria-label="Second group">
                        <button type="submit" name="button" value="publish" class="btn btn-success savesfkj">{{ translate('Save & Publish') }}</button>
                    </div>
                    @endif
                </div>
            </div>
