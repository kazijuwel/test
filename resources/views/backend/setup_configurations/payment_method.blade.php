                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('AamarPay Merchant Id')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="AamarPay_Merchant_ID" value="{{  env('AamarPay_Merchant_ID') }}" placeholder="{{translate('AamarPay Merchant Id')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="aamarpay_sandbox" type="checkbox" @if (\App\BusinessSetting::where('type', 'aamarpay_sandbox')->first()->value == 1)
                                        checked
                                    @endif>
