            ...
            <div class="card-body">
                ...
                @endif
                           ...
                           <!--      <td style="pointer-events: none;">
                                    <label class="aiz-switch aiz-switch-success mb-0" style="pointer-events: none;">
                                        <input  value="{{ $product->id }}" type="checkbox" <?php if($product->admin_approved == 1) echo "checked";?> style="pointer-events: none;">
