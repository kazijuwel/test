...
<script src="{{ asset('public/mobileview') }}/owlcarousel/owl.carousel.js"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('body').append(
            '<div class="toTopImg text-center" style="display:none"> <i class="fa fa-angle-up la-flip-horizontal la-1x" style="font-size:20px"></i></div>'
            );
