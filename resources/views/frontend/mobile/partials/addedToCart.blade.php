<div class="modal-body p-4 added-to-cart">
    ...
    <div class="media mb-4">
        <img src="{{uploaded_asset($product->thumbnail_img) }}" data-src="{{ uploaded_asset($product->thumbnail_img) }}" class="mr-3 lazyload size-100px img-fit rounded" alt="Product Image" height="100px">
            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-10">
                    <div class="h6 text-primary">
                        <strong>
                            {{ single_price(($data['price']+$data['shipping_cost']+$data['commision_rate']+$data['tax'])*$data['quantity']) }}
                        </strong>
                    </div>
                </div>
            </div>
