...
<div class="container">
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-group list-group-flush">
                        @php
                            ...
                            $product_commision_rate_only_price = 0;
                            $product_commision_rate = 0;
                           $product_commision_rate = 0;
                        @endphp
    ...
    if ($product->category->commision_rate) {
            ...
            $product_shipping_cost = $product->shipping_cost;
                                ...
                                //end al
                                #$total = $total + $cartItem['price']*$cartItem['quantity']+$product_commision_rate+$product_shipping_cost +$cartItem['tax']*$cartItem['quantity'];
                                # $total = $total + $cartItem['price']*$cartItem['quantity'] + $product_shipping_cost*$cartItem['quantity'] + $product_commision_rate *$cartItem['quantity'];
                                 #$total = $total +($cartItem['price']+$cartItem['tax'])*$cartItem['quantity']+$product_shipping_cost +$product_commision_rate*$cartItem['quantity'];
                            ...
                            <li class="list-group-item px-0 px-lg-3">
                                <div class="row gutters-5">
                                    ...
                                    <div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0">
                                        ...
                                        <span class="fw-600 fs-16">{{ single_price($cartItem['price']+$product->shipping_cost +$product_commision_rate) }}</span>
                                    </div>
                                        ...
                                        @if($cartItem['digital'] != 1)
                                            <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
                                                ...
                                                <input type="text" name="quantity[{{ $key }}]"
                                                       ...
                                                       max="10" readonly onchange="updateQuantity({{ $key }}, this)">
                                                <button class="btn col-auto btn-icon btn-sm btn-circle btn-light"
                                    ...
                                    <div class="col-lg col-4 order-3 order-lg-0 my-3 my-lg-0">
                                        ...
                                        <span class="fw-600 fs-16 text-primary">{{ single_price(($cartItem['price']+$cartItem['tax'])*$cartItem['quantity']+$product_shipping_cost*$cartItem['quantity'] +$product_commision_rate*$cartItem['quantity']) }}</span>
