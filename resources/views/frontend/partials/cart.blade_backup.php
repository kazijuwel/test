   ...
   data-display="static">
    ...
    @if(Session::has('cart'))
        <span class="badge badge-primary badge-inline badge-pill"
              style="position: relative; top: -5px;right: 5px;">{{ count(Session::get('cart'))}}</span>
               ...
               $product_commision_rate = 0;
                ...
                if($product->discount_type == 'percent'){
                   ...
                   $product_commision_rate = ( $unit_price_discount*$product->category->commision_rate)/100 ;
                    ...
                    $product_commision_rate = (($product->unit_price - $product->discount) *$product->category->commision_rate)/100 ;
                }
                                ...
                                <a href="{{ route('product', $product->slug) }}"
                                   class="text-reset d-flex align-items-center flex-grow-1">
                                    ...
                                    <span class="minw-0 pl-2 flex-grow-1">
                                        ...
                                        <span class="">{{ single_price($cartItem['price']+$product_shipping_cost+$product_commision_rate) }}</span>
                                    </span>
                                </a>
                                <span class="">
