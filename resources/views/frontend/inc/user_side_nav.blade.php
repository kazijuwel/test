            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
               ...
               <!--  <li class="aiz-side-nav-item">
                ...
                @if(Auth::user()->user_type == 'seller')
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('seller_upload_brand') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_upload_brand', 'seller_edit_brand'])}}">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{route('bulk_seller')}}" class="aiz-side-nav-link {{ areActiveRoutes(['bulk_seller'])}}">
               ...
               <!--  @if(\App\BusinessSetting::where('type', 'classified_product')->first()->value == 1)
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('deliveryman.dashboard') }}" class="aiz-side-nav-link {{ areActiveRoutes(['profile'])}}">
                        <i class="las la-dollar-sign aiz-side-nav-icon"></i>
