...
@if(\App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1)
    ...
    @else
        ...
        <head>
            ...
            <meta name="google-site-verification" content="l72ycylsVuNiRE9TGWRBC3EgNi5bSO-5w52V0kwjFEk" />
        ...
        <!-- Favicon -->
            ...
            <style>
                ...
                .carosole1 button.slick-next.slick-arrow {
                    position: absolute;
                    top: -50px;
                    right: 13px;
                }

                .carosole1 button.slick-prev.slick-arrow {
                    position: absolute;
                    top: -50px;
                    left: 986px;
                }

                .carosole2 button.slick-next.slick-arrow {
                    position: absolute;
                    top: -25px;
                    right: 13px;
                }

                .carosole2 button.slick-prev.slick-arrow {
                    position: absolute;
                    top: -25px;
                    left: 986px;
                }
                ...
                .mainDiv:hover .productcarthover {
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-036XZL3R9S"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-036XZL3R9S');
</script>
            @endif
...
'https://connect.facebook.net/en_US/fbevents.js');
 fbq('init', '462210948092558');
fbq('track', 'PageView');
</script>
<noscript>
 <img height="1" width="1"
src="https://www.facebook.com/tr?id=462210948092558&ev=PageView
&noscript=1"/>
</noscript>
<!-- End Facebook Pixel Code -->
        ...
        <div class="d-flex flex-column">
            <div style=" min-height:100%; position:fixed; overflow-y:scroll; overflow-x:hidden; right:-15px; top: 205px;">
                <ul class="list-group text-center m-0 align-items-center" style="width: 50px;">
                    <a href="https://belaobela.com.bd/cart">
                        <li class="list-group-item" style="background-color: #FD6500; cursor:pointer;">
                                <i class="fa fa-shopping-cart text-white"></i>
                        </li>
                    </a>

                   <a href="https://facebook.com/belaobelabd">
                        <li class="list-group-item" style="background-color: #FD6500; cursor:pointer;">
                                <i class="fab fa-facebook text-white"></i>
                        </li>
                   </a>

                    <a href="https://www.instagram.com/belaobela.com.bd">
                        <li class="list-group-item" style="background-color: #FD6500; cursor:pointer;">
                                <i class="fab fa-instagram text-white"></i>
                        </li>
                    </a>

                    <a href="https://belaobela.com.bd/">
                        <li class="list-group-item" style="background-color: #FD6500; cursor:pointer;">
            ...
            @include('frontend.inc.advertisement')
            <!-- Header -->
...
<div class="fb-customerchat"
  ...
  theme_color="#FF5722"  page_id="172709277753976">
</div>
