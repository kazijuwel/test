                        ...
                        <div class="row gutters-5">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            ...
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/New Installation.png')}}" alt="new installation">
                                    ...
                                    <div class="col-sm-2 col-6"  >
                                        <div style="min-height: 110px;" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 ">
                                            ...
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Repairing.png')}}" alt="repaire">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            ...
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Maintanance.png')}}" alt="maintanance">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            ...
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Rental Products.png')}}" alt="rental">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            ...
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Construction Work.png')}}" alt="Construction">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            ...
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Interior Work.png')}}" alt="Interior">
                                                <div class="col-12 text-center">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        ...
                                        <div class="row align-items-center no-gutters">
                                        <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Printing Work.png')}}" alt="Printing">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                        <div class="row align-items-center no-gutters">
                                        <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Tailoring Shop.png')}}" alt="ac repaire">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            <div class="row align-items-center no-gutters">
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Pack & Shift.png')}}" alt="Pack">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            <div class="row align-items-center no-gutters">
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Event Management.png')}}" alt="Event">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            <div class="row align-items-center no-gutters">
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Interior Work.png')}}" alt="Furniture">
                                    ...
                                    <div class="col-sm-2 col-6"   >
                                        <div style="min-height: 110px;" href="#" class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2 " >
                                            <div class="row align-items-center no-gutters">
                                            <img style="height:60px; width:80px; margin:auto;" src="{{asset('public/assets/img/Cleaning Service.png')}}" alt="Cleaning">
