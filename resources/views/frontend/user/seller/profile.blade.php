                ...
                <form action="{{ route('seller.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="tel" pattern="\+?(88)?0?1[3456789][0-9]{8}\b" title="Please Input a valid Phone Number" class="form-control" placeholder="{{ translate('Your Phone')}}" name="phone" value="{{ Auth::user()->phone }}" required autocomplete="off">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-2 col-form-label">{{ translate('Your Profession') }}</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" placeholder="{{ translate('Your Profession') }}" name="profession" value="{{ Auth::user()->profession }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label">{{ translate('Your Date of Birth') }}</label>
                                <div class="col-md-10">
                                    <input type="date" class="form-control" placeholder="{{ translate('Your Date of Birth') }}" name="birth_date" value="{{ Auth::user()->birth_date }}">
                                </div>
                            </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                            <label class="col-md-3 col-form-label">{{ translate('Bkash Payment') }}</label>
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-3">
                                    <input value="1" name="bkash_status" type="checkbox" @if (Auth::user()->seller->bkash_status == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 col-form-label">{{ translate('Nagad Payment') }}</label>
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-3">
                                    <input value="1" name="nagad_status" type="checkbox" @if (Auth::user()->seller->nagad_status == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 col-form-label">{{ translate('Bkash Number') }}</label>
                            <div class="col-md-9">
                                <input autocomplete="off" type="text" class="form-control mb-3" placeholder="{{ translate('Bkash Account Number')}}" value="{{ Auth::user()->seller->bkash }}" name="bkash">
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 col-form-label">{{ translate('Nagad Number') }}</label>
                            <div class="col-md-9">
                                <input autocomplete="off" type="text" class="form-control mb-3" placeholder="{{ translate('Nagad Account Number')}}" value="{{ Auth::user()->seller->nagad }}" name="nagad">
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 col-form-label">{{ translate('Bank Name') }}</label>
                            <div class="col-md-9">
                                <input autocomplete="off" type="text" class="form-control mb-3" placeholder="{{ translate('Bank Name')}}" value="{{ Auth::user()->seller->bank_name }}" name="bank_name">
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 col-form-label">{{ translate('Bank Account Name') }}</label>
                            <div class="col-md-9">
                                <input autocomplete="off" type="text" class="form-control mb-3" placeholder="{{ translate('Bank Account Name')}}" value="{{ Auth::user()->seller->bank_acc_name }}" name="bank_acc_name">
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 col-form-label">{{ translate('Bank Account Number') }}</label>
                            <div class="col-md-9">
                                <input autocomplete="off" type="text" class="form-control mb-3" placeholder="{{ translate('Bank Account Number')}}" value="{{ Auth::user()->seller->bank_acc_no }}" name="bank_acc_no">
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 col-form-label">{{ translate('Bank Routing Number') }}</label>
                            <div class="col-md-9">
                                <input autocomplete="off" type="number" lang="en" class="form-control mb-3" placeholder="{{ translate('Bank Routing Number')}}" value="{{ Auth::user()->seller->bank_routing_no }}" name="bank_routing_no">
                            </div>
                        </div>
                      </div>
                  </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-10">
                                  <div class="input-group mb-3">
                                    <input autocomplete="off" type="email" class="form-control" placeholder="{{ translate('Your Email')}}" name="email" value="{{ Auth::user()->email }}" />
