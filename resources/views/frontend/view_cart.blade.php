                                        ...
                                        <li class="list-group-item px-0 px-lg-3">
                                            <div class="row gutters-5">
                                                ...
                                                <div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0">
                                                    ...
                                                    <span class="fw-600 fs-16">{{ single_price($cartItem['price']+$product_shipping_cost +$product_commision_rate) }}</span>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if (\App\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1)
                        ...
                        <div class="text-center">
                            <a href="{{ route('checkout.shipping_info') }}"
                               class="btn btn-soft-primary">{{ translate('Guest Checkout')}}</a>
                        </div> -->
                    @endif
                </div>
            </div>
