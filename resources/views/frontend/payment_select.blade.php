                    ...
                    <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST" id="checkout-form">
                        ...
                        <div class="card shadow-sm border-0 rounded">
                            ...
                            <div class="card-body text-center">
                                    ...
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        <div class="row gutters-10">
                                            ...
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/aamarpay_pay.jpg')}}" class="img-fluid mb-2">
                                            ...
                                            @if(\App\BusinessSetting::where('type', 'cash_payment')->first()->value == 1)
                                                ...
                                                @if($digital != 1)
                                                    @php
                                                           $delivery_details = \App\DelivryMethod::where('id', Session::get('delivry_method_id'))->get()->first();
                                                           $prOrder =0;
                                                    ...
                                                    @endphp
                                                    @if($delivery_details->delivery_payment_type == 1||2)
                                                    @if($prOrder != 1)
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                ...
                                @endif
                                @if(single_price(Auth::user()->balance) != 0)
