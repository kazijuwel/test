...
Route::prefix('v1')->group(function () {
    ...
    Route::get('products/stock-out-offer', 'Api\ProductController@stockOutOffer');
    ...
    Route::get('user/shipping/set_default/{id}', 'Api\AddressController@set_default')->middleware('auth:api');
    Route::get('user-list', 'Api\UserController@userList')->middleware('auth:api');
    ...
    Route::get('order/track', 'Api\OrderController@trackOrder')->name('trackOrder');
