...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    //Route::get('/refund-request-pay/{el}', 'RefundRequestController@refund_pay')->name('refund_request_money_by_admin');
    ...
    Route::get('/refund-report', 'RefundRequestController@refund_report')->name('refund_report');
});
